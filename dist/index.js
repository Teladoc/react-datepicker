  ...
  Day = (function(e) {
    function t() {
      ...
      return (
        ...
        _defineProperty(_assertThisInitialized(r), "handleOnKeyDown", function(
          e
        ) {
        ...
        _defineProperty(_assertThisInitialized(r), "getAriaLabel", function() {
          var e = r.props.day,
            t = r.isDisabled() || r.isExcluded() ? "Not available" : "Choose";
          return "".concat(t, " ").concat(formatDate(e, "PPPP"));
        }),
        _defineProperty(_assertThisInitialized(r), "getTabIndex", function(
          e,
          t
        ) {
          var n = e || r.props.selected,
            a = t || r.props.preSelection;
          return r.isKeyboardSelected() || (r.isSameDay(n) && isSameDay(a, n))
            ? 0
            : -1;
        }),
      ...
      _createClass(t, [
        {
          ...
          value: function() {
            ...
            return React.createElement(
              "div",
              { className: classnames(e), onClick: this.handleClick },
  ...
  Time = (function(e) {
    function t() {
      ...
      return (
        ...
        _defineProperty(_assertThisInitialized(r), "isDisabledTime", function(
          e
        ) {
          return (
            ((r.props.minTime || r.props.maxTime) &&
          ...
          return e.map(function(e, n) {
            return React.createElement(
              ...
              React.createElement(
                ...
                _extends(
                  {},
                  r.isDisabledTime(e) ? { disabled: "disabled" } : "",
        ...
        _defineProperty(_assertThisInitialized(r), "onKeyDown", function(e) {
          switch (e.key) {
            case "Up":
            case "ArrowUp":
              (r.centerLi = r.centerLi.previousSibling),
                r.centerLi.firstChild.focus();
              break;
            case "Down":
            case "ArrowDown":
              (r.centerLi = r.centerLi.nextSibling),
                r.centerLi.firstChild.focus();
              break;
            case "Esc":
            case "Escape":
            ...
            case " ":
              return;
            case "Home":
              (r.centerLi = r.centerLi.parentNode.firstChild),
                r.centerLi.firstChild.focus();
              break;
            case "End":
              (r.centerLi = r.centerLi.parentNode.lastChild),
                r.centerLi.firstChild.focus();
              break;
            case "Tab":
            default:
...
var inputTime = (function(e) {
  function t(e) {
    ...
    return (
      ...
      _defineProperty(_assertThisInitialized(r), "renderTimeInput", function() {
        var e = r.state.time,
          t = r.props,
          n = t.timeString,
          a = t.customTimeInput;
        return a
          ? React.cloneElement(a, { value: e, onChange: r.onTimeChange })
  ...
  Calendar = (function(e) {
    function t(e) {
      ...
      return (
        ...
        _defineProperty(_assertThisInitialized(r), "renderHeader", function(e) {
          switch (!0) {
  ...
  TabLoop = (function(e) {
    function t(e) {
      ...
      return (
        ...
        _defineProperty(_assertThisInitialized(r), "handleFocusStart", function(
          e
        ) {
          var t = r.getTabChildren();
          t && t.length > 1 && t[t.length - 1].focus();
        }),
        _defineProperty(_assertThisInitialized(r), "handleFocusEnd", function(
          e
        ) {
          var t = r.getTabChildren();
          t && t.length > 1 && t[0].focus();
        }),
        (r.tabLoopRef = React.createRef()),
        r
      );
    }
    return (
        ...
        [
          {
            ...
            value: function() {
              var e,
                ...
                d = t.popperOnKeyDown;
              if (!a) {
                var u = classnames("react-datepicker-popper", r);
                  ...
                  function(e) {
                    ...
                    return React.createElement(
                      ...
                      React.createElement(
                        ...
                        _extends(
                          { ref: t, style: r },
                          { className: u, "data-placement": n, onKeyDown: d }
                        ),
              ...
              var h = classnames("react-datepicker-wrapper", n);
              return React.createElement(
                reactPopper.Manager,
      ...
      return (
        ...
        _defineProperty(_assertThisInitialized(r), "handleTimeChange", function(
          ...
          r.setState({ preSelection: t }),
            r.props.onChange(t),
            r.props.onTimeChange && r.props.onTimeChange(t),
        ...
        _defineProperty(_assertThisInitialized(r), "closeDialog", function() {
          r.setOpen(!1),
            r.inputOk() || r.props.onInputError({ code: 1, msg: INPUT_ERR_1 });
        }),
        _defineProperty(_assertThisInitialized(r), "onKeyDown", function(e) {
          e.stopPropagation(), r.props.onKeyDown(e);
          var t = e.key;
          if (r.state.open || r.props.inline || r.props.preventOpenOnFocus) {
            if (r.state.open) {
              ...
              var a = newDate(r.state.preSelection);
              "Enter" === t
                ? (e.preventDefault(),
                  r.inputOk() &&
        ...
        _defineProperty(_assertThisInitialized(r), "onDayKeyDown", function(e) {
          r.props.onKeyDown(e);
          var t = e.key,
            n = newDate(r.state.preSelection);
          if ("Enter" === t)
            e.preventDefault(),
              r.handleSelect(n, e),
            ...
            r.setState({ lastPreSelectChange: PRESELECT_CHANGE_VIA_NAVIGATE }),
              r.props.adjustDateOnChange && r.setSelected(a),
              r.setPreSelection(a);
          }
        }),
        _defineProperty(_assertThisInitialized(r), "onPopperKeyDown", function(
          e
        ) {
          "Escape" === e.key &&
            (e.preventDefault(),
            r.setState({ preventFocus: !0 }, function() {
              r.setOpen(!1), setTimeout(r.setFocus);
            }));
        }),
            ...
            return r.props.inline || r.isCalendarOpen()
              ? React.createElement(
                  WrappedCalendar,
                  {
                    ...
                    dayClassName: r.props.dayClassName,
                    ariaDescribedBy: r.props.calendarDialogAriaDescribedBy,
