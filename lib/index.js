...
function (_React$Component) {
  ...
  function YearDropdownOptions(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(YearDropdownOptions).call(this, props));
...
function (_React$Component) {
  ...
  function YearDropdown() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(YearDropdown)).call.apply(_getPrototypeOf2, [this].concat(args)));
...
function (_React$Component) {
  ...
  function MonthDropdownOptions() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(MonthDropdownOptions)).call.apply(_getPrototypeOf2, [this].concat(args)));
...
function (_React$Component) {
  ...
  function MonthDropdown() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(MonthDropdown)).call.apply(_getPrototypeOf2, [this].concat(args)));
...
function (_React$Component) {
  ...
  function MonthYearDropdownOptions(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(MonthYearDropdownOptions).call(this, props));
...
function (_React$Component) {
  ...
  function MonthYearDropdown() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(MonthYearDropdown)).call.apply(_getPrototypeOf2, [this].concat(args)));
...
function (_React$Component) {
  ...
  function Day(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "buildAriaLabelText", function (dayString) {
      return _this.isDisabled() ? "".concat(dayString, " is unavailable") : "Select ".concat(dayString);
    });
  ...
  _createClass(Day, [{
    ...
    value: function render() {
      ...
      var dayString = formatDate(this.props.day, DAY_ARIA_LABEL, this.props.locale);
...
function (_React$Component) {
  ...
  function WeekNumber() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(WeekNumber)).call.apply(_getPrototypeOf2, [this].concat(args)));
...
function (_React$Component) {
  ...
  function Month() {
    ...
    _defineProperty(_assertThisInitialized(_this), "isRangeStart", function (m) {
      var _this$props = _this.props,
          day = _this$props.day,
          startDate = _this$props.startDate,
          endDate = _this$props.endDate;
    ...
    _defineProperty(_assertThisInitialized(_this), "getMonthClassNames", function (m) {
      ...
      return classnames("react-datepicker__month-text", "react-datepicker__month-".concat(m), {
        "react-datepicker__month--disabled": (minDate || maxDate) && isMonthDisabled(utils$2(day, m), _this.props),
...
function (_React$Component) {
  ...
  function Time() {
    ...
    _defineProperty(_assertThisInitialized(_this), "isDisabledTime", function (time) {
      return (_this.props.minTime || _this.props.maxTime) && isTimeInDisabledRange(time, _this.props) || _this.props.excludeTimes && isTimeDisabled(time, _this.props.excludeTimes) || _this.props.includeTimes && !isTimeDisabled(time, _this.props.includeTimes);
    });
    ...
    _defineProperty(_assertThisInitialized(_this), "liClasses", function (time, currH, currM) {
      ...
      if (!_this.props.intervals || _this.props.injectTimes && (getHours(time) * 60 + getMinutes(time)) % _this.props.intervals !== 0) {
    ...
    _defineProperty(_assertThisInitialized(_this), "buildAriaLabelText", function (time, format) {
      return _this.isDisabledTime(time) ? "".concat(formatDate(time, format, _this.props.locale), " is unavailable") : "Select ".concat(formatDate(time, format, _this.props.locale));
    });
    ...
    _defineProperty(_assertThisInitialized(_this), "renderTimes", function () {
      ...
      var activeTime = _this.props.selected || _this.props.openToDate || newDate();
...
function (_React$Component) {
  ...
  function inputTime(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(inputTime).call(this, props));
  ...
  function Calendar(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "changeMonthYear", function (monthYear) {
      _this.setState(function (_ref5) {
        var date = _ref5.date;
        return {
          date: setYear(utils$2(date, getMonth(monthYear)), getYear(monthYear))
        };
      }, function () {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderPreviousButton", function () {
      ...
      return React.createElement("button", {
        "aria-label": _this.props.showMonthYearPicker ? _this.props.previousYearButtonLabel : _this.props.previousMonthButtonLabel,
        type: "button",
    ...
    _defineProperty(_assertThisInitialized(_this), "renderNextButton", function () {
      ...
      return React.createElement("button", {
        "aria-label": _this.props.showMonthYearPicker ? _this.props.nextYearButtonLabel : _this.props.nextMonthButtonLabel,
        type: "button",
        className: classes.join(" "),
        onClick: clickHandler
      });
    ...
    _defineProperty(_assertThisInitialized(_this), "renderCustomHeader", function (_ref9) {
      ...
      }, _this.props.renderCustomHeader(_objectSpread2({}, _this.state, {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderInputTimeSection", function () {
      ...
      var timeString = "".concat(addZero(time.getHours()), ":").concat(addZero(time.getMinutes()));
...
function (_React$Component) {
  ...
  function PopperComponent() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(PopperComponent).apply(this, arguments));
  }
  ...
  _createClass(PopperComponent, [{
    ...
    value: function render() {
      ...
      if (!hidePopper) {
        ...
        popper = React.createElement(reactPopper.Popper, _extends({
...
function (_React$Component) {
  ...
  function DatePicker(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleBlur", function (event) {
      if (_this.state.open && !_this.props.withPortal && !_this.props.showTimeInput && !_this.props.showTimeSelect) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleSelect", function (date, event, monthSelectedIn) {
      ...
      if (_this.props.showTimeSelect) {
        setTimeout(function () {
          document.querySelector(".react-datepicker__time-list-item > button:not([disabled])").focus();
        }, 100);
      }
    });
    ...
    _defineProperty(_assertThisInitialized(_this), "renderDateInput", function () {
      ...
      return React.cloneElement(customInput, (_React$cloneElement = {}, _defineProperty(_React$cloneElement, customInputRef, function (input) {
        _this.input = input;
      }), _defineProperty(_React$cloneElement, "aria-hidden", "true"), _defineProperty(_React$cloneElement, "autoComplete", _this.props.autoComplete), _defineProperty(_React$cloneElement, "autoFocus", _this.props.autoFocus), _defineProperty(_React$cloneElement, "className", customInput.props.className + " " + className), _defineProperty(_React$cloneElement, "disabled", _this.props.disabled), _defineProperty(_React$cloneElement, "id", _this.props.id), _defineProperty(_React$cloneElement, "name", _this.props.name), _defineProperty(_React$cloneElement, "onBlur", _this.handleBlur), _defineProperty(_React$cloneElement, "onChange", _this.handleChange), _defineProperty(_React$cloneElement, "onClick", _this.onInputClick), _defineProperty(_React$cloneElement, "onFocus", _this.handleFocus), _defineProperty(_React$cloneElement, "onKeyDown", _this.onKeyDown), _defineProperty(_React$cloneElement, "placeholder", _this.props.placeholderText), _defineProperty(_React$cloneElement, "readOnly", true), _defineProperty(_React$cloneElement, "required", _this.props.required), _defineProperty(_React$cloneElement, "tabIndex", _this.props.tabIndex), _defineProperty(_React$cloneElement, "title", _this.props.title), _defineProperty(_React$cloneElement, "value", inputValue), _React$cloneElement));
    });
